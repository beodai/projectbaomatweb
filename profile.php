...
<head>
  ...
  <title><?php echo "LUXURY HOTEL" ?> - THONG TIN</title>
</head>
<body class="bg-light">
      ...
      <div class="col-md-4 mb-5 px-4">
        <div class="bg-white p-3 p-md-4 rounded shadow-sm">
          <form id="profile-form">
            ...
            <img src="https://demoda.vn/wp-content/uploads/2022/02/anh-cho-hai-huoc-bua-cam-bong-cuoi.jpg" class="rounded-circle img-fluid mb-3">
