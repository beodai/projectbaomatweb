<nav id="nav-bar" class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
  ...
  <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">LUXURY HOTEL</a>
            ...
            echo<<<data
              <div class="btn-group">
                <button type="button" class="btn btn-outline-dark shadow-none dropdown-toggle" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                  <img src="https://demoda.vn/wp-content/uploads/2022/02/anh-cho-hai-huoc-bua-cam-bong-cuoi.jpg" style="width: 25px; height: 25px;" class="me-1 rounded-circle">
                  $_SESSION[uName]
                </button>
