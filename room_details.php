...
<head>
  ...
  <title><?php "LUXURY HOTEL" ?> - CHI TIẾT PHÒNG</title>
</head>
<body class="bg-light">
              ...
              if(mysqli_num_rows($img_q)>0)
              {
                ...
                while($img_res = mysqli_fetch_assoc($img_q))
                {
                  echo"
                    ...
                    <img src='https://www.hoteljob.vn/files/Anh-Hoteljob-Ni/Nam-2021/Thang-3/Cac-lo%E1%BA%A1i-phong-khach-san-03.jpg' class='d-block w-100'>
                    </div>
                  ";
                  $active_class='';
                }
        ...
        <div class="card mb-4 border-0 shadow-sm rounded-3">
          <div class="card-body">
            <?php 
              ...
              echo<<<price
                <h4>$room_data[price] vnđ mỗi đêm</h4>
              price;
