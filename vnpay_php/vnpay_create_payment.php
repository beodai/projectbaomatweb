...
$vnp_TxnRef = $_POST['booking_id']; // Lấy booking_id làm mã giao dịch
...
header('Location: ' . $vnp_Url); //ghi chú dòng này nếu muốn kiểm tra id và giá đã được truyền sang chưa
die();
