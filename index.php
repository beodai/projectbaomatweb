...
<head>
  ...
  <title><?php echo "LUXURY HOTEL"?> - TRANG CHỦ</title>
  <style>
    .availability-form{
      margin-top: -50px;
      z-index: 2;
          ...
          while($row = mysqli_fetch_assoc($res))
          {
            ...
            echo <<<data
              <div class="swiper-slide">
                <img src="https://img.homedy.com/store/images/2020/04/15/phong-ngu-khach-san-5-sao-637225597309796831.jpg" class="w-100 d-block">
              </div>
            data;
          }
        ?>
          ...
          echo <<<data
            <div class="col-lg-4 col-md-6 my-3">
              <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
                <img src="https://www.hoteljob.vn/files/Anh-Hoteljob-Ni/Nam-2021/Thang-3/Cac-lo%E1%BA%A1i-phong-khach-san-03.jpg" class="card-img-top">
                <div class="card-body">
        ...
        while($row = mysqli_fetch_assoc($res)){
          echo<<<data
            <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3">
              <img src="https://static.vecteezy.com/system/resources/previews/000/439/969/original/wifi-vector-icon.jpg" width="60px">
              ...
              echo<<<slides
                <div class="swiper-slide bg-white p-4">
                  <div class="profile d-flex align-items-center mb-3">
                    <img src="https://img.meta.com.vn/Data/image/2021/09/21/anh-cho-cute-de-thuong-dang-yeu-8.jpg" class="rounded-circle" loading="lazy" width="30px">
